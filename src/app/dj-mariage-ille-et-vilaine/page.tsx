...
export const metadata: Metadata = {
  ...
  description: "DJ animateur mariage en Ille-et-Vilaine (35) : Rennes, Saint-Malo, Fougères, Vitré. Avis 5★, dès 1200€ TTC. 25 ans d'expérience. Devis gratuit sous 24h ✓",
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Nous proposons nos animations signature : AnimaJet (quiz interactif, photo mystère, partage live), notre plateforme que nous avons développée, photobooth vintage TSF années 60, étincelles froides certifiées CE pour l\'ouverture de bal, fumée lourde et jeux lumineux. Des prestations qui font la différence !',
  },
  {
...
export default function DJMariageIlleEtVilaine() {
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      {/* Maillage AnimaJet */}
      <AnimaJetMeshBlock cityName="Ille-et-Vilaine" placeLabel="en Ille-et-Vilaine" />
