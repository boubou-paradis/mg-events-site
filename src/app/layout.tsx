...
export const metadata: Metadata = {
  ...
  description: "DJ mariage Bretagne — 25 ans d'expérience, AnimaJet notre plateforme d'animations interactives maison, photobooth vintage, étincelles froides certifiées CE. Animation élégante de la cérémonie laïque à la soirée dansante. Devis gratuit ✓",
